...
```
Comenzando con la interpretación de la regresión lineal, si observamos la gráfica podemos darnos cuenta de que ésta y el valor obtenido en el estudio de correlación numérica son coherentes entre sí. Esto se debe a que, como podemos ver la gráfica posee una correcta regresión lineal, pero algunos datos erróneos provocan un descenso en el coeficiente de correlación lineal.
