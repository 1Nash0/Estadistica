...
Para hacer el análisis de esta variable vamos a estudir su frecuencia relativa y absoluta.
...
Aquí vamos a realizar el estudio de la varible number_of_reviews
...
Primero vamos a hacer un histograma con los datos para poder visualizarlos mejor.
...
Luego hacemos un gráfico de dispersión de regrsión lineal.
...
Observando la gráfica podemos darnos cuenta de que ésta y el valor obtenido en el estudio de correlación numérica son coherentes entre sí. Esto se debe a que, como podemos ver la gráfica posee una correcta regresión lineal, pero algunos datos erróneos provocan un descenso en el coeficiente de correlación lineal.
...
Podemos observar que la correlación entre el precio y el resto de variables no es muy elevado, y es muy paracido en todas, en cambio podemos observar como hay una mayor correlación entre el número de habitaciones y el número de baños, y sobre todo entre el número de habitaciones y el número de camas.
...
Por último, vemos que la variable bedrooms explica el 34,8% de la variablilidad de bathroom, lo cual no nos resulta muy útil ya que entonces el resultado obtenido en el estudio no es muy fiable ya que no es un valor muy elevado.
